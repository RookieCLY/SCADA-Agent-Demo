"""Real-LLM smoke test for the GLM provider.

Boots the orchestrator under ``configs/glm_smoke.yaml`` (flat tools,
...
trace summary so we can eyeball whether the end-to-end loop closed and measure latency.

Run from the repo root:

    venv/Scripts/python scripts/test_glm.py
"""
...
# `python scripts/test_glm.py` without an `-e .` install.
